...
public class EntryDetailsFragment extends Fragment implements DatePickerFragment.DateSelected, TimePickerFragment.TimeSelected{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    bSave.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if(mEditTitle.getText().toString().equals("") || bDate.getText().toString().equals("DATE") || bStart.getText().toString().equals("Start Time") || bEnd.getText().toString().equals("End Time"))
